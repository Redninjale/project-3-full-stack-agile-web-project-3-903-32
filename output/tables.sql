        ...
        VALUES (1, 'Tender Entree', 4.99);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (2, 'Corn Dog Value Meal', 4.99);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (3, '2 Hot Dog Value Meal', 4.99);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (4, 'Bacon Cheeseburger', 8.29);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (5, 'Black Bean Burger', 7.59);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (6, 'Cheeseburger', 6.89);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (7, 'Gig Em Patty Melt', 7.59);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (8, 'Classic Hamburger', 6.89);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (9, 'Aggie Chicken Club', 8.39);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (10, 'Revs Grilled Chicken Sandwich', 8.39);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (11, 'Spicy Chicken Sandwich', 8.39);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (12, 'Chicken Caesar Salad', 8.29);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (13, 'Double Scoop Ice Cream', 3.29);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (14, 'Aggie Shakes', 4.49);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (15, 'Cookie Ice Cream Sundae', 4.69);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (16, 'Root Bear Float', 5.49);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (17, 'French Fries', 1.99);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (18, 'Aquafina Water 16OZ', 1.79);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (19, 'Aquafina Water 20OZ', 2.39);
        


        INSERT INTO Menu (id, itemName, price)
        VALUES (20, 'Pepsi Fountain 20OZ', 1.99);
